...
class SonoffMINIZB2GSL extends SonoffBase {
    ...
    async onNodeInit({ zclNode }) {
        ...
        this.log(`MINI-ZB2GS-L Channel ${ep} initializing (Device ID: ${this.getData().id})`);
        ...
        if (this.hasCapability('onoff')) {
            ...
            this.registerCapabilityListener('onoff', async (value, opts) => {
                ...
                if (detachModeStr === 'on_button_switch') {
                    const clickTrigger = this.homey.flow.getDeviceTriggerCard("MINI-ZB2GS-L:click");
                    if (clickTrigger) {
        ...
        const triggerToggleForDevice = (targetDevice) => {
            ...
            if (detachMode === 'on_button' || detachMode === 'on_button_switch') {
                ...
                const clickTrigger = targetDevice.homey.flow.getDeviceTriggerCard("MINI-ZB2GS-L:click");
                if (clickTrigger) {
